        ...
        <div className="h-[320px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={dadosTemporais} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
              ...
              <XAxis dataKey="data_formatada" stroke="#94a3b8" tick={{fontSize: 12, fill: '#94a3b8'}} axisLine={false} tickLine={false} />
              <YAxis stroke="#94a3b8" tick={{fontSize: 12, fill: '#94a3b8'}} axisLine={false} tickLine={false} />
              <Tooltip contentStyle={tooltipStyle} />
              <Legend wrapperStyle={{ paddingTop: '20px' }} />
              <Line type="monotone" dataKey="total_casos" name="Total de Notificações" stroke="url(#colorLine)" strokeWidth={4} dot={{ r: 4, fill: '#f43f5e', strokeWidth: 2, stroke: '#0f172a' }} activeDot={{ r: 7, strokeWidth: 0 }} filter="url(#glow)" />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
